...
public class operadoresRelacionais {
	...
	public static void main(String[] args) {
		...
		// * O Java só consegue comparar os tipos normais, através do operador "==", com
		// números que
		// estão no intervalo de "-128" até "127". Fora desse intervalo, o operador "=="
		// pode causar muita
		// confusão quando utilizado com os tipos normais. Utilizado juntamente com os
		// primitivos (que,
		// nesse caso, seria o "int" ao invés de "Integer") o operador "==" funciona
		// para qualquer número.
		// * Caso você utilize a mesma variável, o operador "==" vai funcionar até para
		// os tipos
		// normais. Isso porque o valor de uma variável sempre será igual a ele mesmo.
		// Repare que, em nosso
		// exemplo, utilizamos duas variáveis com o mesmo valor, pois, isso é o que
